          ...
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                ...
                <p class="grey-text text-lighten-4">JNTUH UCE PALAIR COLLEGE , MADHULAPALLY VILLAGE , KUSUMANCHI MANDAL , KHAMMAM , TELANGANA .</p>
                <p class="grey-text text-lighten-4">Phone : +91 7569199421 </p>
              </div>
